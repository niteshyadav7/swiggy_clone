      ...
      <footer className="bg-gray-700 dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-bold">
                <li className="mb-4">
                  <Link to="#" className=" hover:underline text-base text-black">
                    About
                  </Link>
                </li>
                <li className="mb-4">
          ...
          <div className="px-4 py-6 bg-gray-700 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-xl text-gray-500 dark:text-gray-300 xl:text-center">
              © 2023{" "}
              <Link
                to="https://www.linkedin.com/in/nitesh-yadav-aa9229268/"
                target="_blank"
              >
                Nitesh Yadav
              </Link>
